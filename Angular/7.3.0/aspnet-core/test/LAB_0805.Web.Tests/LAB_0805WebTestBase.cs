...
{
    public abstract class LAB_0805WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LAB_0805WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LAB_0805WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LAB_0805DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LAB_0805DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LAB_0805DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LAB_0805DbContext, Task<T>> func)
        {
            T result;
